...
# 設定推播目標
TARGET_USER_ID = 8914979364
TARGET_GROUP_ID = -5541294363
TARGET_CHANNEL_ID = -1004312524004
...
async def main():
    ...
    keyboard = InlineKeyboardMarkup([
        [
            InlineKeyboardButton("🛍️ 立即下單", url="https://t.me/+XbZImTD0XJ9iYzI9"),
            InlineKeyboardButton("💬 聯絡店長", url="https://t.me/+XbZImTD0XJ9iYzI9")
        ]
    ])
